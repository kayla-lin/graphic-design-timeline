      ...
      <main className={`${source.className} bg-slate-950 pb-64`}>
        ...
        <Timeline>
          ...
          <TimelineElement
            ...
            img="xerox.jpeg"
            desc={[
              "Xerox launched the first personal computer for the office. This was the birth of the first ever graphic user interface (GUI). Norman Lloyd Cox converted the ideal of the office into a metaphor on the computer screen. He used skeuomorphism to represent basic office concepts, like desktop, files, folders, on the computer screen.",
            ]}
          />
          <TimelineElement
