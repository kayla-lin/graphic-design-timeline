    ...
    <main className={`${source.className} bg-slate-950`}>
      ...
      <Timeline>
        ...
        <TimelineElement
          ...
          img="warhol.jpeg"
          desc={
            "In 1985, Warhol became a Commodore International representative. He created a series of 28 digital “experiments” to help advertise the computer, Amiga 1000."
          }
        />
      </Timeline>
    </main>
