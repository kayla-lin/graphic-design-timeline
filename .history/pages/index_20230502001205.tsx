      ...
      <main className={`${source.className} bg-slate-950 pb-64`}>
        ...
        <Timeline>
          ...
          <TimelineElement
            ...
            img="susankare.jpeg"
            desc={[
              "Susan Kare is the graphic designer who gave the Macintosh a smile. Pixel art was the best kind of graphics that computing power could hope for. However, the small amount of pixels were crucial for intuitive interfaces and designs. Susan Kare created the original set of icons for the original Apple Macintosh.",
