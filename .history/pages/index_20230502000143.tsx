        ...
        <Timeline>
          ...
          <TimelineElement
            ...
            desc={[
              ...
              "Cox used the office as a metaphor for the computer. The main hub, the 'desk', correlated to the computer's desktop. Files hold information and paper in the office. On the computer, files represented an object that held data/information, like text. Folders held multiple files. And on the computer, folders held multiple files just like their real life counterpart.",
            ]}
          />
          <TimelineElement
