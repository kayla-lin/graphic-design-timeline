    ...
    <main className={`${source.className} bg-slate-950`}>
      ...
      <Timeline>
        ...
        <TimelineElement
          ...
          img="css.webp"
          desc={[
            "It was not a priority for how websites could be laid out. It was difficult to code the website to have designs. Berners-Lee was more interested in the web as a digital directory of employees. Take Pei-Yuan Wei was one of the first who tried to make his own language for styling websites. Wei never quite found success in standardizing his language, but he was an inspiration for his successor Hakon Wium Lie who created Cascading Style Sheets, or just CSS.",
