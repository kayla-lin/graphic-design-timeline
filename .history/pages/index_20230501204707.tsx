    ...
    <main className={`${source.className} bg-slate-950`}>
      ...
      <Timeline>
        ...
        <TimelineElement
          ...
          img="kanarek.png"
          desc={[
            "Another one of these artists was Dutch artist Joan Heemsherk. He was responsible for many of the best-loved internet artworks of the 90s, including Jodi.org. The website includes a page of random numbers of symbols like a programmer’s terminal window. Viewing the page source HTML code (right click, “View Page Source) reveals the hidden artwork.",
          ]}
