        ...
        <Timeline>
          ...
          <TimelineElement
            ...
            desc={[
              ...
              "Cox used the office as a metaphor for the computer. The main hub, the 'desk', correlated to the desktop. Files represented an object that held information, like text. Folders held multiple files.",
            ]}
          />
          <TimelineElement
