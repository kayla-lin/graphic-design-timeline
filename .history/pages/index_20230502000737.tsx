      ...
      <main className={`${source.className} bg-slate-950 pb-64`}>
        ...
        <Timeline>
          <TimelineElement
            ...
            img="skeumorphic.png"
            desc={[
              "Skeuomorphism involves creating a design that mimics its real life counterpart. For example, an icon of a trash can for deleting files, or a floppy disk for the save functionality. Skeuomorphism designs often had beveled edges, gradients, and reflections. It is a useful concept for design. It was useful because of its design affordance: a shape that suggests its use. Since graphical interfaces on the computer were new. Computer interfaces would be much more intuitive with skeuomorphism. ",
            ]}
          />
          <TimelineElement
