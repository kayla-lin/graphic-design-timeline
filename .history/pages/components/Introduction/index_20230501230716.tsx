...
const Introduction = () => {
  return (
    <>
      ...
      <section>
        The digital revolution is a period of advances in digital computers and
        software, which changed graphic design. Computers allowed designers easy
        access to graphic tools, allowing for easy experimentation.
        Additionally, the release of the internet created a whole new area of
        graphic design; People scrambled to integrate graphics and animation
