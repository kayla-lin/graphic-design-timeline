      ...
      <section className="container mx-auto text-white py-32 flex justify-center items-center gap-10">
        <div className="flex flex-col gap-5">
          ...
          <p>
            ...
            were more Swiss Modern: simple and flat. However, design still
            benefited from the intuitiveness of skeuomorphism--flat design
            became a mix of skeuomorphism and flat design, and gave rise of the
            isometric design trend.
          </p>
        </div>
        <Sign />
      </section>
